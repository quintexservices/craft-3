    		...
    		<div class="col-md-9" id="mainContent">
    			...
    			<div class="tab-content">
    				...
    				<div class="tab-pane fade" id="tab2">
    					...
    					<div class="alert">
    						<button type="button" class="close fui-cross" data-dismiss="alert"></button>
    						<h4>Delete this user (<?php echo $theUser->first_name;?> <?php echo $theUser->last_name;?>)</h4>
    						<p>
    						...
    						<a href="<?php echo site_url('users/delete/'.$theUser->user_id);?>" class="btn btn-danger btn-embossed"><span class="fui-cross-inverted"></span> I understand, please delete this user</a>
    					</div>
