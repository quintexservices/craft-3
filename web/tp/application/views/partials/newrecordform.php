			...
			<?php endif;?>
				...
				<?php elseif( isset($field['additional_data']['select']) ):?>
					...
					<select name="<?php echo $field['field'];?>" id="new_<?php echo $field['field']?>">
						...
						<option value="<?php echo $option;?>" <?php if( $field['additional_data']['default'] == $option ):?>selected<?php endif;?> ><?php echo $option;?></option>
						<?php endforeach;?>
					</select>
		  			...
		  			<?php if( $field['type'] == 'date' ):?>
		  				...
		  				<div class="input-group">
		  					<span class="input-group-btn">
		  			  		...
		  			  		<input type="text" name="<?php echo $field['field'];?>" placeholder="<?php echo $field['field'];?> (YYYY-MM-DD)" class="form-control date" value="" id="new_<?php echo $field['field']?>" style="position: relative; z-index: 2000;">
		  				</div>
