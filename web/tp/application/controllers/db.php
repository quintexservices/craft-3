	...
	*/
	...
	public function newRecord($table)
	{
		...
		if ($this->form_validation->run() == FALSE) {
            ...
            $res = $this->dbmodel->newRecord($table, $_POST);
			...
			if( $res['code'] == 1 ) {
                ...
                $this->data['error_message_heading'] = "Ouch!";
                $this->data['error_message'] = "Something went wrong when trying to save your data. Please see the error details below:<br>".$res['error'];
